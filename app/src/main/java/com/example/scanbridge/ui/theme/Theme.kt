...
// خود گوشی). طبق درخواست کاربر، حالا اپ همیشه روشن است و هم‌رنگ نرم‌افزار دسکتاپ: پس‌زمینه‌ی
// سفید/روشن + دکمه‌های بنفشِ پررنگ. چیدمان/استایل (گردی گوشه‌ها، افکت شیشه‌ای روی دوربین و غیره)
